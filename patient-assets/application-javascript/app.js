...
exports.connectToNetwork = async function (doctorID, hospId = 1) {
    ...
    if (hospId === 1)
        ...
        const response = {};
        response.error = 'Please define the hospital Id to connect to network';
        return response;
    }
...
exports.invoke = async function (networkObj, isQuery, func, args = '') {
    try {
        ...
        const response = {};
        response.error = error;
        console.log("___________________________$$$$$$$$$$$$$$$__________________")
